<template>
  <div class="container">
    <div class="passengerInfo">
      ...
      <el-form>
        <el-form-item label="乘机人类型">
          <el-input placeholder="姓名" v-model="users[0].username" class="input-with-select">
        ...
        <el-form-item label="证件类型">
          <el-input placeholder="证件号码" v-model="users[0].id" class="input-with-select">
            <el-select value="1" slot="prepend" placeholder="请选择">
    ...
    <el-button type="primary" class="add-user">添加乘机人</el-button>
    <div class="insurance">
      <h2>保险</h2>
